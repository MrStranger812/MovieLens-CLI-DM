...
create_env "movielens-base" "3.10" \
    "pandas=2.1.4 numpy=1.26.3 scipy=1.11.4 matplotlib=3.8.2 seaborn=0.13.1 plotly=5.18.0 pytest=7.4.3 hypothesis=6.98.0" \
    "" "base"
...
conda create -y -n movielens-rapids -c rapidsai -c conda-forge -c nvidia \
  cudf=25.04 cuml=25.04 python=3.10 pip cudatoolkit=12.8 \
...
create_env "movielens-profiling" "3.10" \
    "pandas=2.1.4 numpy=1.26.3 scipy=1.11.4 line_profiler=4.1.1 memory_profiler=0.61.0 snakeviz=2.2.1" \
    "" "profiling"

# Optimization environment
create_env "movielens-optimization" "3.10" \
    "pandas=2.1.4 numpy=1.26.3 scipy=1.11.4 numba=0.58.1 dask=2024.2.1 pyarrow=15.0.0" \
    "" "optimization"

# Documentation environment
create_env "movielens-docs" "3.10" \
    "pandas=2.1.4 numpy=1.26.3 scipy=1.11.4 sphinx=7.2.6 sphinx-rtd-theme=2.0.0 mkdocs=1.5.3"  \
    "" "docs"

# Testing environment
create_env "movielens-testing" "3.10" \
    "pandas=2.1.4 numpy=1.26.3 scipy=1.11.4 pytest=7.4.3 hypothesis=6.98.0 coverage=7.4.1" \
    "" "testing"

# Create a development environment that combines all tools
create_env "movielens-dev" "3.10" \
    "pandas=2.1.4 numpy=1.26.3 scipy=1.11.4 matplotlib=3.8.2 seaborn=0.13.1 plotly=5.18.0 pytest=7.4.3 hypothesis=6.98.0" \
    "" "base"
